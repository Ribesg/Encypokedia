...
import fr.ribesg.android.encypokedia.tools.listadapter.ListAdapter
import fr.ribesg.android.encypokedia.tools.listadapter.ListAdapterItem
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(bundle: Bundle?) {
        ...
        listView {
            adapter = ListAdapter(
                listOf(
                    Item(this@MainActivity, "A"),
                    Item(this@MainActivity, "X", "Y", "Z"),
                    Item(this@MainActivity, 1.toString(), 2.toString(), 3.toString())
                )
            )
        }
    }
